...
def activity(token, act):
                ...
                print(f'''{Fore.YELLOW}[>]{Fore.WHITE} Activity Status: {act} {Fore.YELLOW}|{Fore.BLUE} {token}''')
...
for token in tokens:
        ...
        Write.Input("[>]Press ENTER to exit and stop the Activity Changer!", Colors.purple_to_blue, interval=0.000)
